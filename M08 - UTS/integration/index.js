...
const fileDir = __dirname + '/public/assets/tmdbMovies.json/tmdbMovies.json'
...
app.get('/movie/:id', (req, res) => {
    ...
    if (dataId != undefined) {
        res.status(200).sendFile(__dirname + '/public/view/movie.html')
    }
    else {
        res.status(404).sendFile(__dirname + '/public/view/movieNotFound.html')
    }
})
